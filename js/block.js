$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function (block) {
      ...
      $('#blockTransactionFees').text(numeral(block.totalFeeAmount / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.000') + ' ' + ExplorerConfig.ticker)
      ...
      for (var i = 0; i < block.transactions.length; i++) {
        ...
        transactions.row.add([
          txn.hash,
          numeral(txn.fee / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.000'),
